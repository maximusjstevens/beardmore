...
%Max Added:
%Before setting the pointer style with "set(gcf,'pointer', style)" add
%original_pointer_style=get(gcf,'pointer');
%at the end of the routine, restore the pointer with:
...
for i = 1:n
    while 1
        ...
        if sum(point1 == point2) == 2        % same points
            ...
            gca();
            hold on;
            plot(point1(1),point1(2),'r.','markersize',12);
            break;
        end
