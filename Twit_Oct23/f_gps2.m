...
%  based on the GPS. 
% Assume pretrigger data in filtrate have already been removed 
...
%   array.
filtdata2=[filtdata2 ; zeros(sz2(1)-sz(1),sz(2))];
...
for i = 1:sz(2)
        filtdata2( 1+max_disp-Displacement(i):max_disp-Displacement(i)+sz(1),i) = filtdata(1:sz(1),i);
        filtdata2(1:1+max_disp-Displacement(i)-1, i ) = zeros(size(filtdata(1:1+max_disp-Displacement(i)-1, i )));  
end
